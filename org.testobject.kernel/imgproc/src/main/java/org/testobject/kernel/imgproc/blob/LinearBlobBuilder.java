...
public class LinearBlobBuilder
{
	...
	public Blob build(ArrayRaster r)
	{
		...
		final int width = r.getSize().width;
		final int height = r.getSize().height;
		...
		*/
		...
		//        System.out.println("idSource=" + idSource + ", merges=" + merges + ", num blobs=" + Utils.countBlobs(root));
	...
	private static final Blob buildTree(B b, int[][] ids)
	{
		...
		Rectangle bbox = new Rectangle(b.minx, b.miny, b.maxx - b.minx + 1, b.maxy - b.miny + 1);

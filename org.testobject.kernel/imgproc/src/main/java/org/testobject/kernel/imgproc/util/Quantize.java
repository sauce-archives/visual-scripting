...
public class Quantize {
	...
	public static BufferedImage to256Colors(BufferedImage image) throws IOException {
	...
	public static BufferedImage to8Colors(BufferedImage image) throws IOException {
		final int[][] pixels = ImageUtil.getPixels(image);
